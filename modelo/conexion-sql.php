...
begin
  ...
  begin
    ...
    @tipotec = 'P', 
    @conorden = CONORDEN, 
    @cod_mipres = (SELECT SUBSTRING(CD_SERVICIO, 1, 6) FROM SERVICIOS_AUTORIZADOS 
             WHERE NO_SOLICITUD = @no_solicitud
             AND TABLA = @tabla AND CD_SERVICIO = @servicio) 
  ...
  begin
    ...
    @tipotec = 'M', 
    @conorden = CONORDEN, 
    @cod_mipres = (SELECT CD_SERVICIO FROM SERVICIOS_AUTORIZADOS 
             WHERE NO_SOLICITUD = @no_solicitud
             AND TABLA = @tabla AND CD_SERVICIO = @servicio) 
  ...
  WHERE NO_SOLICITUD = @no_solicitud AND TABLA =  @tabla AND CD_SERVICIO = @servicio;
...
$('#progreso').modal('show');
setTimeout(function(){ contador2(titulo); }, 1500);
}
...
document.getElementById('progreso_titulo').innerHTML = titulo+"..";
setTimeout(function(){ contador3(titulo); }, 1500);
}
...
setTimeout(function(){ contador1(titulo); }, 1500);
}
