...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a  href="index.php?x=038">Servicios Prescritos / Direccionamientos</a></li>
  </ol>
</nav>
		 ...
		 <div class="col-md-12 sm-12">
			<div class="card">
			  <div class="card-header">
			    <H4>Servicios Prescritos / Direccionamientos</H4>
			  </div>
			  <div class="card-body">

			  	<form class="" action="vista/templates/ListarServiciosSeguimiento.php" method="post">
					<div class="form-row">
...
document.getElementById('ListarAutorizaciones').innerHTML = "<center><div class='spinner-border text-success'></center></div>";
	...
	$.post("vista/templates/ListarServiciosSeguimiento.php", {fechainicial: fechainicial,fechafinal:fechafinal}, function(data){
