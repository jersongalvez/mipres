        ...
        <div class="card-body">
            <div class="form-row">
                <div class="col-md-3 sm-12">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" id="valor" name="valor" placeholder="Prescripción" autofocus="true" autocomplete="off">
                    </div> 
                </div>
            ...
            <div class="form-row" style="margin-top: 15px;">
                <div class="col-md-4 sm-12" style="margin-top: 32px;">
                    <button class="btn btn-outline-dark btn-block" type="button" id="btnBuscarDireccionamiento" onclick="buscar_prescripcionAn()">Buscar</button> 
                </div>

                <div class="col-md-4 sm-12" style="margin-top: 32px;">
                    <button class="btn btn-outline-primary btn-block" type="button" id="btnAnular" onclick="put_AnulardatosFacturados()" disabled="true">Anular</button> 
                </div>

                <div class="col-md-4 sm-12" style="margin-top: 32px;">
                    <button class="btn btn-outline-danger btn-block" type="button" id="btnLimpiar" onclick="limpiar_frm()" disabled="true">Limpiar</button> 
                </div>
            </div>  
        </div>
    </div>
