    ...
    <div class="row">
        <div class="col-md-3 sm-12">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="btn btn-outline-dark btn-block" id="v-pills-profile-tab" href="index.php?x=021"><center>Anular No Direccionamiento</center></a>
            </div>
        </div>
                                        ...
                                        switch ($http_code = curl_getinfo($ch, CURLINFO_HTTP_CODE)) {
                                            case 200:  # OK
                                                ...
                                                if ($stmt === FALSE) {
                                                    ...
                                                    echo "<button type='button' class='close' data-dismiss='alert'>&times;</button>";
                                                    echo "<strong>Mensaje:</strong> Se ha realizado la anulación del No Direccionamiento " . $_POST['IDNODireccionamiento'] . "</div>";
                                                }
