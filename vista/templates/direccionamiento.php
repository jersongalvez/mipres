...
<div class="row">
  <div class="col-md-3 sm-12">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      <a class="btn btn-outline-dark btn-block" id="v-pills-profile-tab" href="index.php?x=007&y=001&TI=<?php echo $row['TP_IDENT_AFILIA']; ?>&NI=<?php echo $row['NR_IDENT_AFILIA']; ?>"><center>Regresar por Usuario</center></a>
      <a class="btn btn-outline-dark btn-block" id="v-pills-profile-tab" href="index.php?x=035"><center>Ser. sin Direccionar</center></a>
      <a class="btn btn-outline-dark btn-block" id="v-pills-profile-tab" href="index.php?x=007"><center>Cancelar</center></a>
      <br>
      <button class='btn btn-outline-dark btn-block' type='button' onclick="javascript:HistoricoEntregas();">Historico de Entregas</button>
    </div>
  </div>
...
<input type="hidden" class="form-control" id="NO_SOLICITUD" name="NO_SOLICITUD" required  value="<?php echo $NO_SOLICITUD; ?>">
<input type="hidden" class="form-control" id="TABLA" name="TABLA" required  value="<?php echo $TABLA; ?>">
<input type="hidden" class="form-control" id="CD_SERVICIO" name="CD_SERVICIO" required  value="<?php echo $CD_SERVICIO; ?>">
<input type="hidden" class="form-control" id="DES_TEM_TOKEN" name="DES_TEM_TOKEN" required  value="<?php echo $row['DES_TEM_TOKEN']; ?>">
...
<input type="number" class="form-control" id="NoPrescripcion" name="NoPrescripcion" required readonly value="<?php echo $row['NUM_COMITECTC']; ?>">
  <div class="input-group-append">
    <button class="btn btn-outline-secondary" type="button" id="BtnRelacionar" onclick="javascript:ServiciosSolicitados();">Relacionar Servicio</button>
  </div>
</div>
</div>
</div>
...
<div class="col-md-8 sm-12">
<input type="text" class="form-control" id="Regimen_s" name="Regimen_s" required readonly value="<?php echo $row['TIP_REGIMEN']; ?>"> 
</div>
</div>
<div class="form-row">
<div class="col-md-4 sm-12">
...
<div class="col-md-8 sm-12">
<input type="text" class="form-control" id="TipoTec" name="TipoTec" required readonly value="<?php echo $row['TIPOTEC']; ?>"> 
</div>
</div>
<div class="form-row">
<div class="col-md-4 sm-12">
...
<div class="col-md-8 sm-12">
<input type="number" class="form-control" id="ConTec" name="ConTec" required readonly value="<?php echo $row['CONTEC']; ?>"> 
</div>
</div>
<div class="form-row">
<div class="col-md-4 sm-12">
...
<div class="col-md-8 sm-12">
<input type="text" class="form-control" id="CodSerTecAEntregar" name="CodSerTecAEntregar" required readonly value="<?php echo $row['CODSERTEC']; ?>">
</div>
</div>
<div class="form-row">
<div class="col-md-4 sm-12">
...
<div class="col-md-8 sm-12">
<input type="number" class="form-control" id="NoIDPaciente" name="NoIDPaciente" required readonly value="<?php echo $row['NR_IDENT_AFILIA']; ?>">
</div>
</div>
<div class="form-row">
<div class="col-md-4 sm-12">
...
<div class="col-md-8 sm-12">
<input type="text" class="form-control" id="TipoIDProv" name="TipoIDProv" required readonly value="<?php echo ValorRefMipres($conn,'DIRECCIONAMIENTO','TipoIDProv',$row['TIP_IDENTIFICACION']); ?>">
</div>
</div>
<div class="form-row">
<div class="col-md-4 sm-12">
...
<div class="col-md-8 sm-12">
<input type="number" class="form-control" id="NoIDProv" name="NoIDProv" required readonly value="<?php echo QuitarCerosIzquierda($row['NR_IDENT_PREST_IPS']); ?>">
</div>
</div>
<div class="form-row">
<div class="col-md-4 sm-12">
...
<div class="col-md-8 sm-12">
<input type="date" class="form-control" id="FecMaxEnt" name="FecMaxEnt" value="<?php echo $FecMaxEnt; ?>"  required readonly>
</div>
</div>
<div class="form-row">
<div class="col-md-4 sm-12">
...
<div class="col-md-8 sm-12">
<input type="number" class="form-control" id="CantTotAEntregar" name="CantTotAEntregar" required readonly value="<?php echo $row['CANTIDAD']; ?>">
</div>
</div>
<div class="form-row">
<div class="col-md-4 sm-12">
...
<div class="col-md-8 sm-12">
<input type="text" class="form-control" id="DirPaciente" name="DirPaciente"  required readonly value="<?php if( ($row['DIR_AFILIADO'] <> '') or (empty(!$row['DIR_AFILIADO'])) ){
    ...
    <div class="col-md-12 sm-12">
      <div class="card">
        <div class="card-body">
          ...
          <div class="col-md-8 sm-12">
          <input type="number" class="form-control" id="Id" name="Id" required readonly value="<?php echo $row['IDENTIFICADOR']; ?>">
          </div>
          </div>
          <div class="form-row">
          <div class="col-md-4 sm-12">
          ...
          <div class="col-md-8 sm-12">
          <input type="number" class="form-control" id="IdDireccionamiento" name="IdDireccionamiento" required readonly value="<?php echo $row['IDDIRECCIONAMIENTO']; ?>"> 
          </div>
          </div>
          <div class="form-row">
          <div class="col-md-12 sm-12">               
...
?>
<button class='btn btn-outline-dark btn-block' type='submit' onclick="javascript:progreso('Consultando');">Generar Direccionamiento</button>
<?php 
}
?>
</div>          
