                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <form class="" action="index.php?x=009" method="post" >
                                ...
                                <input type="hidden" class="form-control" id="CD_SERVICIO" name="CD_SERVICIO" required  value="<?php echo cd_medicamento1($TABLA, $CD_SERVICIO); ?>">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-8 sm-12">
                                        <input type="text" class="form-control" id="CodSerTecAEntregar" name="CodSerTecAEntregar" required readonly value="<?php echo cd_medicamento1($TABLA, $row['CODSERTEC']); ?>">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-4 sm-12">
