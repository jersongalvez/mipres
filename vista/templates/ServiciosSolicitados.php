                ...
                <tbody>
                    ...
                    while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-outline-dark btn-block" type="submit" onclick="javascript:Relacionar('<?php echo $row['TIPOTEC']; ?>', '<?php echo $row['CONORDEN']; ?>', '<?php echo cd_medicamento1(substr($row['TIPO'], 0, 3), $row['COD_MIPRES']); ?>');">Relacionar</button>  
                            </td>
                        </tr>
            <?php
        }
