	          ...
	          { 
				...
				?>
				      <tr>
						...
						<td>
						<button class="btn btn-outline-dark btn-block" type="submit" onclick="javascript:Relacionar('<?php echo $row['TIPOTEC']; ?>','<?php echo $row['CONORDEN']; ?>','<?php echo $row['COD_MIPRES']; ?>');">Relacionar</button>  
						</td>
				      </tr>
				<?php
	          }
