...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a  href="index.php?x=033">Reporte de Entrega por Fecha</a></li>
  </ol>
</nav>
...
<div class="row">
  <div class="col-md-3 sm-12">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      <a class="btn btn-light" id="v-pills-profile-tab" href="index.php?x=033"><center>Regresar</center></a>
    </div>
    <br>
...
<div class="card ">
  <div class="card-header">
    <H4>Reporte de Entrega por Fecha</H4>
  </div>
  <div class="card-body">      
...
//ERROR0006
  if (!empty($_SESSION['NIT_EPS'])){   
    ...
    $sql = "SELECT (SELECT DES_TEM_TOKEN FROM PRS_TEM_TOKEN WHERE TIP_TEM_TOKEN = '".$_POST['var_regimen']."') AS DES_TEM_TOKEN,* FROM PRS_URL_SERVICES WHERE COD_URL = '14' ";
    $params = array();
...
switch ($http_code = curl_getinfo($ch, CURLINFO_HTTP_CODE)) {
        ...
        <a class="list-group-item list-group-item-action list-group-item-info"><span class="badge badge-info badge-pill"><?php echo count($tamaño_array); ?></span> Reporte de Entrega encontradas <?php echo  $_POST['var_fecha'];?></a>
        </div>
        <div id="global">
        <div id="mensajes">
        <div class="texto">
...
<?php
            ...
            <strong>Solicitud con exito!</strong> No se encontraron Reporte de Entrega.
            </div>
            <?php
            }
