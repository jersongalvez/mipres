                ...
                <tbody>
                    ...
                    while ($row2 = sqlsrv_fetch_array($stmt2, SQLSRV_FETCH_ASSOC)) {
                        ...
                        <tr>
                            ...
                            <td>
                              <button class="btn btn-outline-danger btn-sm" type="button" id="BtnAsociar" onclick="javascript:AsociarSuministros('<?php echo $row2['NO_SOLICITUD']; ?>', '<?php echo $row2['TABLA']; ?>', '<?php echo $row2['CD_SERVICIO']; ?>');">Asociar</button>
                            </td> 
                        </tr>
