<div class="container-fluid" style="margin-top:80px">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a  href="index.php?x=006">Direccionamiento por Fecha</a></li>
        </ol>
    </nav>
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="card ">
                        <div class="card-header">
                            <H4>Direccionamiento por Fecha</H4>
                        </div>
                        <div class="card-body">      
                            <form class="" action="index.php?x=006&y=001" method="post"  >
                                <div class="form-row">
                                ...
                                <br>
                                <button onclick="document.getElementById('barra').style.display = 'block';"
                                        class="btn btn-outline-success btn-block" type="submit">Consultar a MIPRES</button>  
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        if (isset($_GET["y"])) {
                            ...
                            switch ($_GET["y"]) {
                                case '001':
                                    require_once("services/GET-api-Prescripcion-nit-fecha-token.php");
                                    if (!curl_errno($ch)) {
                                            ...
                                            case 200:  # OK
                                                ...
                                                if (count($tamaño_array) <> 0) {
                                                    ...
                                                    <form action='vista/templates/prescripcion.php' method='post'>
                                                        ...
                                                        <input type='hidden' name='nombre_archivo' value="<?php echo $var_regimen . '-' . $var_fecha ?>">
                                                        <input type='submit' value="<?php echo $var_regimen . '-' . $var_fecha ?>" class="btn btn-success btn-block">
                                                    </form>
                            <?php
                        } else {
                            ?>
